...
function BeginGameState:init()
    ...
    -- mbg - setting level to 1 as this is only called when game begins
    --self.board = Board(VIRTUAL_WIDTH - 272, 16, 2)
...
function BeginGameState:enter(def)
    ...
    --MBG TODO / could this be done in init? I am confused about this 
