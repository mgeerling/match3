...
--TODO include a level parameter as well 
...
function Board:initializeTiles()
    ...
    local shinyFlag = math.random(1,2)
    if shinyFlag == 1 then 
        shinyTile =  self.tiles[math.random(1,8)][math.random(1,8)]
                ...
                if matchNum >= 3 then
                    ...
                    for x2 = x - 1, x - matchNum, -1 do
                        ...
                        if self.tiles[y][x2].shiny == true then 
                            for y3 = 1, 8 do 
                                --TODO super sound 
                                table.insert(match, self.tiles[y3][x2])
                            end 
                        else 
                ...
                if matchNum >= 3 then
                    ...
                    for y2 = y - 1, y - matchNum, -1 do
                        if self.tiles[y2][x].shiny == true then 
                            -- self:shinyMatch(self.tiles[y2][x],"vertical")
                        end 
